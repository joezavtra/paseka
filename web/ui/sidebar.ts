...
export interface SidebarOptions {
  pack: Pack;
  /** Видимость: восстановленная из хранилища либо умолчание (см. defaultVisibility). */
...
/**
 * Каталоги, которые почти никогда не нужны на сцене. По умолчанию из этого
 * списка скрыт только `vendor` (см. defaultVisibility в state/visibility.ts):
 * он есть почти всегда и почти всегда крупнее остального кода. Остальное
 * прячется только по нажатию — инструмент не должен молча прятать данные. Кнопка
