 ...
 * приложение.
 *
 * Раньше эти величины были константами в `web/layout/graph.ts`, и каждая
 * подобрана замером (числа и методика — в докблоках там же). Значения по
 * умолчанию здесь — ровно те, что были замерены; панель настроек нужна, чтобы
 * искать лучшие, а не чтобы заменить обоснование ползунком.
 */
