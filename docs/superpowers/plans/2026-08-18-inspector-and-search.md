...
**Spec:** [2026-08-17-gource-reborn-design.md](../specs/2026-08-17-gource-reborn-design.md) — §9 (подпись свёрнутой папки), §10 (поиск), §11 (подписи), §12 (инспектор). Вторая половина среза 5.
